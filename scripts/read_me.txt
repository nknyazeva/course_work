...
9. frequency_n.py - считает число N на месте стоп-кодона по всему гену в других организмах.
На входе: direct - папка со всеми генами (/mnt/lustre/potapova/200_flies/all_genes/).
На выходе:
        stop_codon_relative_coordinate.txt - файл с данными в формате json с информацией о стоп-кодонах
            внутри генов без отрезанных 5% гена с обоих сторон (координата, стоп-кодон, имя файла).
