...
# in_file = '_'.join(["/Users/anastasia/PycharmProjects/course_work/threshold_genes_with_stop", str(threshold)])
# in_file_wo_stop = "/Users/anastasia/PycharmProjects/course_work/files_wo_stop_codons.txt"
# in_file_no_threshold = '_'.join(["/Users/anastasia/PycharmProjects/course_work/no_threshold_genes_with_stop", str(threshold)])
# out_file_frequency_codon = '_'.join(["/Users/anastasia/PycharmProjects/course_work/frequencyCodon_gene", str(threshold)])
# out_file_frequency_codon_counting = '_'.join(["/Users/anastasia/PycharmProjects/course_work/frequencyCodon_gene_counting", str(threshold)])


in_file = '_'.join(["/mnt/lustre/nknyazeva/courseWork4/scripts/output/threshold_genes_with_stop", str(threshold)])
in_file_wo_stop = "/mnt/lustre/nknyazeva/courseWork4/scripts/output/files_wo_stop_codons.txt"
in_file_no_threshold = '_'.join(["/mnt/lustre/nknyazeva/courseWork4/scripts/output/no_threshold_genes_with_stop", str(threshold)])
out_file_frequency_codon = '_'.join(["/mnt/lustre/nknyazeva/courseWork4/scripts/output/frequencyCodon_gene", str(threshold)])
out_file_frequency_codon_counting = '_'.join(["/mnt/lustre/nknyazeva/courseWork4/scripts/output/frequencyCodon_gene_counting", str(threshold)])

# in_file = "/mnt/lustre/nknyazeva/courseWork4/scripts/output/threshold_genes_with_stop.txt"
# in_file_wo_stop = "/mnt/lustre/nknyazeva/courseWork4/scripts/output/files_wo_stop_codons.txt"
# out_file_frequency_codon = "/mnt/lustre/nknyazeva/courseWork4/scripts/output/description_pairs_genes.txt"
# out_file_frequency_codon_counting = "/mnt/lustre/nknyazeva/courseWork4/scripts/output/frequency_pairs_genes.txt"
